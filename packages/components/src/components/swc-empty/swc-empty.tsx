...
@Component({
  tag: 'swc-empty',
  styleUrl: 'swc-empty.css',
  shadow: true,
})
export class SwcEmpty {
  render() {
    return (
      <Host>
        <div class="ivy-empty__image">
          <slot name="image">
              ...
              <g id="Illustrations" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="B-type" transform="translate(-1268.000000, -535.000000)">
                  <g id="Group-2" transform="translate(1268.000000, 535.000000)">
                    ...
                    <rect id="Rectangle-Copy-15" fill="url(#linearGradient-2-7)" x="13" y="45" width="40" height="36"></rect>
                    <g id="Rectangle-Copy-17" transform="translate(53.000000, 45.000000)">
                      <mask id="mask-4-7" fill="white">
                        <use href="#path-3-7"></use>
                      </mask>
                      <use id="Mask" fill="#E0E3E9" transform="translate(8.500000, 18.000000) scale(-1, 1) translate(-8.500000, -18.000000) " href="#path-3-7"></use>
                      <polygon
                        id="Rectangle-Copy"
                        fill="#D5D7DE"
                        mask="url(#mask-4-7)"
