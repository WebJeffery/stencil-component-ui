class SwcIconWallet extends HTMLElement {
        constructor() {
          super();
      ...
      export default SwcIconWallet;
      function install(){
        if(window.customElements.get('swc-icon-wallet')) return;
        window.customElements.define('swc-icon-wallet', SwcIconWallet);
      }
