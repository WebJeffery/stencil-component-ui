class SwcIconInfoFilled extends HTMLElement {
        constructor() {
          super();
      ...
      export default SwcIconInfoFilled;
      function install(){
        if(window.customElements.get('swc-icon-info-filled')) return;
        window.customElements.define('swc-icon-info-filled', SwcIconInfoFilled);
      }
