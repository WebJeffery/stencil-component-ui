class SwcIconDessert extends HTMLElement {
        constructor() {
          super();
      ...
      export default SwcIconDessert;
      function install(){
        if(window.customElements.get('swc-icon-dessert')) return;
        window.customElements.define('swc-icon-dessert', SwcIconDessert);
      }
