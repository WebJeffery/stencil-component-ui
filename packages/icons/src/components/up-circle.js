class IvyIconUpCircle extends HTMLElement {
      ...
      export default IvyIconUpCircle;
      function install(){
        if(window.customElements.get('swc-icon-up-circle')) return;
        window.customElements.define('swc-icon-up-circle', IvyIconUpCircle);
      }
