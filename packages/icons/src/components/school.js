class IvyIconSchool extends HTMLElement {
      ...
      export default IvyIconSchool;
      function install(){
        if(window.customElements.get('swc-icon-school')) return;
        window.customElements.define('swc-icon-school', IvyIconSchool);
      }
