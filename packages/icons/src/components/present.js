class SwcIconPresent extends HTMLElement {
        constructor() {
          super();
      ...
      export default SwcIconPresent;
      function install(){
        if(window.customElements.get('swc-icon-present')) return;
        window.customElements.define('swc-icon-present', SwcIconPresent);
      }
