class IvyIconLock extends HTMLElement {
        constructor() {
          super();
      ...
      export default IvyIconLock;
      function install(){
        if(window.customElements.get('swc-icon-lock')) return;
        window.customElements.define('swc-icon-lock', IvyIconLock);
      }
