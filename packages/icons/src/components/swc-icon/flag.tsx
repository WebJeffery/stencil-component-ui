import { Component, h, Prop } from '@stencil/core';
  ...
  export class SwcIconFlag {
    ...
    render() {
      ...
      return (
          <div class={className} style={style} innerHTML={`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><path fill="currentColor" d="M288 128h608L736 384l160 256H288v320h-96V64h96z"/></svg>`}>
          </div>
      );
    }
  }
