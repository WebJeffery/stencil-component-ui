import { Component, h, Prop } from '@stencil/core';
  ...
  @Component({
    tag: 'swc-icon-eleme-filled'
  })
  export class SwcIconElemeFilled {
    /**
     * icon 尺寸 默认 20
     */
