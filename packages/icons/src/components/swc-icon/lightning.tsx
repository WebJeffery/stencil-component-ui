import { Component, h, Prop } from '@stencil/core';
  ...
  @Component({
    tag: 'swc-icon-lightning'
  })
  export class SwcIconLightning {
    /**
     * icon 尺寸 默认 20
     */
