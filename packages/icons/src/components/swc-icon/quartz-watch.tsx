import { Component, h, Prop } from '@stencil/core';
  ...
  @Component({
    tag: 'swc-icon-quartz-watch'
  })
  export class SwcIconQuartzWatch {
    /**
     * icon 尺寸 默认 20
     */
