import { Component, h, Prop } from '@stencil/core';
  ...
  @Component({
    tag: 'swc-icon-partly-cloudy'
  })
  export class SwcIconPartlyCloudy {
    /**
     * icon 尺寸 默认 20
     */
