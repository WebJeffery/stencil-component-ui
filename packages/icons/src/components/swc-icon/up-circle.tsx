import { Component, h, Prop } from '@stencil/core';
  ...
  @Component({
    tag: 'swc-icon-up-circle'
  })
  export class SwcIconUpCircle {
    /**
     * icon 尺寸 默认 20
     */
